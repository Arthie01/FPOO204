...
public class SolicitudArticulos2 {
    ...
    public SolicitudArticulos2(String departamento, Articulo2 articulo, int cantidadSolicitada) {
        ...
        this.fecha = LocalDate.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd")); // Inicializar la fecha
    }
    ...
    public static void actualizarEstadoSolicitud() {
        ...
        try {
            ...
            if (nuevoEstado != null) {
                // Si el nuevo estado es "Aprobado", descontar la cantidad del artículo
                if (nuevoEstado.equals("Aprobado")) {
                    ...
                    if (articulo.getCantidad() >= cantidadSolicitada) {
                        articulo.modificarCantidad(-cantidadSolicitada); // Descontar la cantidad
                        solicitud.setEstado(nuevoEstado); // Actualizar el estado de la solicitud
                    ...
                    // Si el estado no es "Aprobado", solo actualizar el estado
